...
Foram utilizadas as informações do enunciado registrado em `Docs/Estudo de caso 01`, que estabelece 100 horas semanais de acabamento, 80 horas de carpintaria e limite de 40 bonecos. O enunciado também informa lucro unitário de R$ 4 para bonecos e R$ 2 para trens, além da extensão de minimização com custos unitários de R$ 5 e R$ 3, respectivamente.
